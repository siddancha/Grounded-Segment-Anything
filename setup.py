...
def get_extensions():
    ...
    if (torch.cuda.is_available() and CUDA_HOME is not None) or \
        ...
        raise ValueError(
            ...
            "Please make sure that CUDA is installed and the CUDA_HOME environment variable is set."
        )
...
version_file = 'grounded-sam-osx/transformer_utils/mmpose/version.py'
...
def add_mim_extension():
    ...
    repo_path = osp.join(osp.dirname(__file__), 'grounded-sam-osx/transformer_utils')
